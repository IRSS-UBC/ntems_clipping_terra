...
# 
shp_path <- "X:\\home\\yye\\ntems_clipping_terra\\shapefiles"
...
# 
# print(paste0("Mask save name: ", mask_save_names))
# 
...
masks_path <- here::here("shapefiles")
mask_save_names <- list.files(path = masks_path, pattern = "vld_ext\\.shp$", full.names = TRUE)
print(paste0("Mask save name: ", mask_save_names))
